        ...
        <div class="center_content">
               <div class="center_search_bar"  >         
                <form name="Form" action=""   method="POST">
                    <div style=" width: 90%">  
                        <div style=" width: 100%">
                            <label  style="width:150px;display: inline-block; ">Title</label>
                            <label  style="width:150px;display: inline-block;">Artist</label>
                            <label  style="width:200px;display: inline-block;">Launch Date</label>
                        </div>
                    ...
                    <div  style=" margin-top: -50px ">
                        <input class="button" style="float: right;" name ="search" value="Search" type="submit" > 
                    </div>    
                </form>
            </div>
            <?php
...
?>
 <div class="center_title_bar" style=" margin-bottom: 0px;font-size:  24px; "> Searched Products List </div> 
         
             <?php
                    echo "<table border='1' class='center_title_bar' style=' margin-bottom: 20px; width :109%'  >
                                        <tr>
                                        <th>product_id</th>
                                        <th>title</th>
                                        <th>artist</th>
            ...
            <div class="center_title_bar" style=" margin-bottom: 0px;font-size:  24px; "> All Products </div> 
...
?>
            ...
            <div class="center_title_bar" style=" margin-top:10px ;font-size:  24px" > Up comings Products</div>
            <div class="prod_box">
