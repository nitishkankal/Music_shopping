...
//retrieve session data
                                            ...
                                            <li class="active"><a href="add_user.php" accesskey="4" title="">Add user</a></li>
            ...
            <div style="margin:0 auto;text-align: left; ">
                ...
                <form name="registrationForm" action="" onSubmit="return validation();" method="POST">
                    ...
                    <table id="content" >
                        ...
                        <tr>        
                            <td colspan="3"> <center><font size="3"><b> Enter the following details </b></font></center></td>        
                        </tr>
                        <!----- First Name ---------------------------------------------------------->
                        <tr>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $result = mysql_query($statement);
                                     ...
                                     if ($result && isset($result)) {
                                        echo '</br>';
                                        echo 'New User Account is added in database successfully';
                                    } else {
                                        echo 'Please enter all required data, account is not added';
                                    }
                                }
                                ?>
                            </td>
